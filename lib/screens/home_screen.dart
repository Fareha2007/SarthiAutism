...
import 'package:sarthi_flutter_project/screens/memory_card_game.dart';
import 'package:sarthi_flutter_project/screens/sound_game_screen.dart';
import 'package:sarthi_flutter_project/screens/videos_screen.dart'; // ← ADD THIS
import '../utils/colors.dart';
import '../utils/routes.dart';
import '../widgets/widgets.dart';
import '../models/models.dart';
        ...
        child: SingleChildScrollView(
          ...
          child: Column(
            children: [
                        ...
                        child: Column(
                          ...
                          children: [
                            ...
                            Text(
                              '${child.age} yrs · ${child.supportLevel} support',
                              style: const TextStyle(
                                  fontSize: 13, color: SC.textMuted),
                            ),
                          ],
                        ),
                      ),
              ...
              // ── ▶️ VIDEOS CARD ─────────────────────────────
              // Place: between screening result and games section
              GestureDetector(
                onTap: () => Navigator.push(
                  context,
                  MaterialPageRoute(
                ...
                child: Container(
                  ...
                  decoration: BoxDecoration(
                    color: SC.lavLight,
                    borderRadius: BorderRadius.circular(18),
                    border: Border.all(color: SC.lavender, width: 1.5),
                    boxShadow: [
                      BoxShadow(
                      ...
                      const Expanded(
                        child: Column(
                          ...
                          children: [
                            ...
                            SizedBox(height: 3),
                            Text(
                              'Awareness, therapy tips & govt. schemes',
                              style:
                                  TextStyle(fontSize: 13, color: SC.textMuted),
                            ),
                          ],
                        ),
                      ),
